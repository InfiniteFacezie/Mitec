      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-6 text-[10px] font-black uppercase tracking-[0.2em] text-blue-100/60">
          ...
          <div className="relative group">
            <button className="hover:text-white transition-colors">Technologies ▼</button>
          ...
          <a href="#contacts" className="bg-blue-600 text-white px-5 py-2 rounded-sm hover:bg-white hover:text-blue-600 transition-all">Contact</a>
        </div>
      </div>
    </nav>
  );
